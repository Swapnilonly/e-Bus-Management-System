...
// Set default theme to light mode if nothing is in localStorage
...
console.log("Initial theme setup complete:", savedTheme);
...
toggleButton.addEventListener("click", () => {
  ...
  // Determine the new theme (default is light, toggle to dark)
  const newTheme = currentTheme === "dark" ? "light" : "dark";

  // Debug: Log the theme change
  console.log("Switching theme:", currentTheme, "to", newTheme);
